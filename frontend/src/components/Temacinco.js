...
<div className="card border-success mb-3">
  ...
  <div className="card-body">
    ...
    <p className="card-text">De hecho, muchos artículos pueden reciclarse varias veces, lo que conlleva ahorros importantes de energía y recursos naturales. Vidrios y metales, entre ellos el alumio, pueden reciclarse indefinidamente sin perder su calidad, La calidad del papel a partir de contenido reciclado ha mejorado drásticamente en los ultimos años. El folio medio de papel de impresora virgen puede reciclaje de cinco a siete veces.</p>
  </div>
</div>
