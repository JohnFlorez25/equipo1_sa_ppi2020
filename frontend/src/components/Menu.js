...
const Menu = (props) => {
  ...
  <nav className="my-2 my-md-0 mr-md-3">
    <a className="p-2 text-danger" href="/Cuestionariouno">Juego</a>
    <a className="p-2 text-dark" href="/">Ranking</a>
    <a className="p-2 text-dark" href="/">Eliminar perfil</a>
    
  </nav>
  <Link 
  className="btn btn-outline-primary" to="/">Cerrar sesión</Link>
</div>
